...
function poncho_get_color_schemes() {
	 ...
	 *
	 */
	return apply_filters( 'poncho_color_schemes',
		array(
			'default' => array(
...
function poncho_customize_preview_js() {
	wp_enqueue_script( 'poncho-customize-preview',
...
//	) ) );
	...
	$wp_customize->add_setting( 'seccion_links_no_destacados_con_descripcion_categoria',
		array(
			'default'           => 0,
			'sanitize_callback' => 'absint',
		) );
	$wp_customize->add_control( new DropdownCategoria( $wp_customize,
		'seccion_links_no_destacados_con_descripcion_categoria',
		array(
			'section'     => 'poncho_seccion_links_no_destacados_con_descripcion',
			'label'       => esc_html__( 'Categoría', 'poncho' ),
			'description' => esc_html__( 'Elegi una categoría para que sea mostrada en esta sección.', 'poncho' ),
...
//	);
	...
	$wp_customize->add_setting( 'seccion_links_destacados_con_icono_descripcion_categoria',
		array(
			'default'           => 0,
			'sanitize_callback' => 'absint',
		) );
...
//	);
	...
	$wp_customize->add_setting( 'seccion_links_destacados_con_fotos_categoria',
		array(
			'default'           => 0,
			'sanitize_callback' => 'absint',
		) );
...
//	Contacto / Social
	...
	$social_links = array(
		...
		'RSS'          => 'poncho_rss_text',
		'SesionEnVivo' => 'poncho_ver_sesion_en_vivo'
	);
